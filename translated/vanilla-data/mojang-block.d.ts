 ...
 */
export type FireStates = Pick<BlockStateSuperset, 'age' | 'minecraft:connection_down' | 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_up' | 'minecraft:connection_west'>;
/**
