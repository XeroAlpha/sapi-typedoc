...
export declare enum MinecraftBlockTypes {
    ...
    BlackConcreteDoubleSlab = "minecraft:black_concrete_double_slab",
    ...
    BlueConcreteDoubleSlab = "minecraft:blue_concrete_double_slab",
    ...
    BrownConcreteDoubleSlab = "minecraft:brown_concrete_double_slab",
    ...
    CyanConcreteDoubleSlab = "minecraft:cyan_concrete_double_slab",
    ...
    GrayConcreteDoubleSlab = "minecraft:gray_concrete_double_slab",
    ...
    GreenConcreteDoubleSlab = "minecraft:green_concrete_double_slab",
    ...
    LightBlueConcreteDoubleSlab = "minecraft:light_blue_concrete_double_slab",
    ...
    LightGrayConcreteDoubleSlab = "minecraft:light_gray_concrete_double_slab",
    ...
    LimeConcreteDoubleSlab = "minecraft:lime_concrete_double_slab",
    ...
    MagentaConcreteDoubleSlab = "minecraft:magenta_concrete_double_slab",
    ...
    OrangeConcreteDoubleSlab = "minecraft:orange_concrete_double_slab",
    ...
    PinkConcreteDoubleSlab = "minecraft:pink_concrete_double_slab",
    ...
    PoplarDoubleSlab = "minecraft:poplar_double_slab",
    ...
    PoplarStandingSign = "minecraft:poplar_standing_sign",
    PoplarTrapdoor = "minecraft:poplar_trapdoor",
    PoplarWallSign = "minecraft:poplar_wall_sign",
    ...
    PurpleConcreteDoubleSlab = "minecraft:purple_concrete_double_slab",
    ...
    RedConcreteDoubleSlab = "minecraft:red_concrete_double_slab",
    ...
    WhiteConcreteDoubleSlab = "minecraft:white_concrete_double_slab",
    ...
    YellowConcreteDoubleSlab = "minecraft:yellow_concrete_double_slab",
...
export type BlockStateSuperset = {
    ...
    ['redstone_east']?: string;
    ['redstone_north']?: string;
    ['redstone_signal']?: number;
    ['redstone_south']?: string;
    ['redstone_west']?: string;
...
/**
 * States specific to AcaciaFence
 */
export type AcaciaFenceStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 ...
 */
export type AcaciaStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type AndesiteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to BambooFence
 */
export type BambooFenceStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 ...
 */
export type BambooMosaicStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type BambooStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to BirchFence
 */
export type BirchFenceStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 ...
 */
export type BirchStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to BlackConcreteDoubleSlab
 */
export type BlackConcreteDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to BlackConcreteSlab
 */
export type BlackConcreteSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to BlackConcreteStairs
 */
export type BlackConcreteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 * States specific to BlackGlazedTerracotta
 */
export type BlackGlazedTerracottaStates = Pick<BlockStateSuperset, 'facing_direction'>;
/**
 * States specific to BlackStainedGlassPane
 */
export type BlackStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to BlackWoolDoubleSlab
 */
export type BlackWoolDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to BlackWoolSlab
 */
export type BlackWoolSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to BlackWoolStairs
 */
export type BlackWoolStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type BlackstoneStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to BlueConcreteDoubleSlab
 */
export type BlueConcreteDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to BlueConcreteSlab
 */
export type BlueConcreteSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to BlueConcreteStairs
 */
export type BlueConcreteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 * States specific to BlueGlazedTerracotta
 */
export type BlueGlazedTerracottaStates = Pick<BlockStateSuperset, 'facing_direction'>;
/**
 * States specific to BlueStainedGlassPane
 */
export type BlueStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to BlueWoolDoubleSlab
 */
export type BlueWoolDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to BlueWoolSlab
 */
export type BlueWoolSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to BlueWoolStairs
 */
export type BlueWoolStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type BrickStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to BrownConcreteDoubleSlab
 */
export type BrownConcreteDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to BrownConcreteSlab
 */
export type BrownConcreteSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to BrownConcreteStairs
 */
export type BrownConcreteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to BrownStainedGlassPane
 */
export type BrownStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to BrownWoolDoubleSlab
 */
export type BrownWoolDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to BrownWoolSlab
 */
export type BrownWoolSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to BrownWoolStairs
 */
export type BrownWoolStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to CherryFence
 */
export type CherryFenceStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 ...
 */
export type CherryStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to ChorusPlant
 */
export type ChorusPlantStates = Pick<BlockStateSuperset, 'minecraft:connection_down' | 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_up' | 'minecraft:connection_west'>;
/**
 ...
 */
export type CinnabarBrickStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type CinnabarStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type CobbledDeepslateStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to CopperBars
 */
export type CopperBarsStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
...
/**
 * States specific to CrimsonFence
 */
export type CrimsonFenceStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 ...
 */
export type CrimsonStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type CutCopperStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to CyanConcreteDoubleSlab
 */
export type CyanConcreteDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to CyanConcreteSlab
 */
export type CyanConcreteSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to CyanConcreteStairs
 */
export type CyanConcreteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 * States specific to CyanGlazedTerracotta
 */
export type CyanGlazedTerracottaStates = Pick<BlockStateSuperset, 'facing_direction'>;
/**
 * States specific to CyanStainedGlassPane
 */
export type CyanStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to CyanWoolDoubleSlab
 */
export type CyanWoolDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to CyanWoolSlab
 */
export type CyanWoolSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to CyanWoolStairs
 */
export type CyanWoolStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to DarkOakFence
 */
export type DarkOakFenceStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 ...
 */
export type DarkOakStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type DarkPrismarineStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type DeepslateBrickStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type DeepslateTileStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type DioriteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type EndBrickStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to ExposedCopperBars
 */
export type ExposedCopperBarsStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 ...
 */
export type ExposedCutCopperStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type FireStates = Pick<BlockStateSuperset, 'age' | 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_up' | 'minecraft:connection_west'>;
/**
...
/**
 * States specific to GlassPane
 */
export type GlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 ...
 */
export type GraniteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to GrayConcreteDoubleSlab
 */
export type GrayConcreteDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to GrayConcreteSlab
 */
export type GrayConcreteSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to GrayConcreteStairs
 */
export type GrayConcreteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 * States specific to GrayGlazedTerracotta
 */
export type GrayGlazedTerracottaStates = Pick<BlockStateSuperset, 'facing_direction'>;
/**
 * States specific to GrayStainedGlassPane
 */
export type GrayStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to GrayWoolDoubleSlab
 */
export type GrayWoolDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to GrayWoolSlab
 */
export type GrayWoolSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to GrayWoolStairs
 */
export type GrayWoolStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to GreenConcreteDoubleSlab
 */
export type GreenConcreteDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to GreenConcreteSlab
 */
export type GreenConcreteSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to GreenConcreteStairs
 */
export type GreenConcreteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 * States specific to GreenGlazedTerracotta
 */
export type GreenGlazedTerracottaStates = Pick<BlockStateSuperset, 'facing_direction'>;
/**
 * States specific to GreenStainedGlassPane
 */
export type GreenStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to GreenWoolDoubleSlab
 */
export type GreenWoolDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to GreenWoolSlab
 */
export type GreenWoolSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to GreenWoolStairs
 */
export type GreenWoolStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 * States specific to Grindstone
 */
export type GrindstoneStates = Pick<BlockStateSuperset, 'attachment' | 'direction'>;
/**
 * States specific to HardBlackStainedGlassPane
 */
export type HardBlackStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to HardBlueStainedGlassPane
 */
export type HardBlueStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to HardBrownStainedGlassPane
 */
export type HardBrownStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to HardCyanStainedGlassPane
 */
export type HardCyanStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to HardGlassPane
 */
export type HardGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to HardGrayStainedGlassPane
 */
export type HardGrayStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to HardGreenStainedGlassPane
 */
export type HardGreenStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to HardLightBlueStainedGlassPane
 */
export type HardLightBlueStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to HardLightGrayStainedGlassPane
 */
export type HardLightGrayStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to HardLimeStainedGlassPane
 */
export type HardLimeStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to HardMagentaStainedGlassPane
 */
export type HardMagentaStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to HardOrangeStainedGlassPane
 */
export type HardOrangeStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to HardPinkStainedGlassPane
 */
export type HardPinkStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to HardPurpleStainedGlassPane
 */
export type HardPurpleStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to HardRedStainedGlassPane
 */
export type HardRedStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to HardWhiteStainedGlassPane
 */
export type HardWhiteStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to HardYellowStainedGlassPane
 */
export type HardYellowStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
...
/**
 * States specific to IronBars
 */
export type IronBarsStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
...
/**
 * States specific to JungleFence
 */
export type JungleFenceStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 ...
 */
export type JungleStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to LightBlueConcreteDoubleSlab
 */
export type LightBlueConcreteDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to LightBlueConcreteSlab
 */
export type LightBlueConcreteSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to LightBlueConcreteStairs
 */
export type LightBlueConcreteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to LightBlueStainedGlassPane
 */
export type LightBlueStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to LightBlueWoolDoubleSlab
 */
export type LightBlueWoolDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to LightBlueWoolSlab
 */
export type LightBlueWoolSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to LightBlueWoolStairs
 */
export type LightBlueWoolStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to LightGrayConcreteDoubleSlab
 */
export type LightGrayConcreteDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to LightGrayConcreteSlab
 */
export type LightGrayConcreteSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to LightGrayConcreteStairs
 */
export type LightGrayConcreteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 * States specific to LightGrayStainedGlassPane
 */
export type LightGrayStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to LightGrayWoolDoubleSlab
 */
export type LightGrayWoolDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to LightGrayWoolSlab
 */
export type LightGrayWoolSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to LightGrayWoolStairs
 */
export type LightGrayWoolStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to LimeConcreteDoubleSlab
 */
export type LimeConcreteDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to LimeConcreteSlab
 */
export type LimeConcreteSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to LimeConcreteStairs
 */
export type LimeConcreteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 * States specific to LimeGlazedTerracotta
 */
export type LimeGlazedTerracottaStates = Pick<BlockStateSuperset, 'facing_direction'>;
/**
 * States specific to LimeStainedGlassPane
 */
export type LimeStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to LimeWoolDoubleSlab
 */
export type LimeWoolDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to LimeWoolSlab
 */
export type LimeWoolSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to LimeWoolStairs
 */
export type LimeWoolStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to MagentaConcreteDoubleSlab
 */
export type MagentaConcreteDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to MagentaConcreteSlab
 */
export type MagentaConcreteSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to MagentaConcreteStairs
 */
export type MagentaConcreteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to MagentaStainedGlassPane
 */
export type MagentaStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to MagentaWoolDoubleSlab
 */
export type MagentaWoolDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to MagentaWoolSlab
 */
export type MagentaWoolSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to MagentaWoolStairs
 */
export type MagentaWoolStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to MangroveFence
 */
export type MangroveFenceStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 ...
 */
export type MangroveStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type MossyCobblestoneStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type MossyStoneBrickStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type MudBrickStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to NetherBrickFence
 */
export type NetherBrickFenceStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 ...
 */
export type NetherBrickStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type NormalStoneStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 * States specific to OakDoubleSlab
 */
export type OakDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to OakFence
 */
export type OakFenceStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 ...
 */
export type OakStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to OrangeConcreteDoubleSlab
 */
export type OrangeConcreteDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to OrangeConcreteSlab
 */
export type OrangeConcreteSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to OrangeConcreteStairs
 */
export type OrangeConcreteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to OrangePoplarLeaves
 */
export type OrangePoplarLeavesStates = Pick<BlockStateSuperset, 'persistent_bit' | 'update_bit'>;
/**
 * States specific to OrangeStainedGlassPane
 */
export type OrangeStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to OrangeWoolDoubleSlab
 */
export type OrangeWoolDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to OrangeWoolSlab
 */
export type OrangeWoolSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to OrangeWoolStairs
 */
export type OrangeWoolStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 * States specific to OxidizedCopperBars
 */
export type OxidizedCopperBarsStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 ...
 */
export type OxidizedCutCopperStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to PaleOakFence
 */
export type PaleOakFenceStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 ...
 */
export type PaleOakStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to PinkConcreteDoubleSlab
 */
export type PinkConcreteDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to PinkConcreteSlab
 */
export type PinkConcreteSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to PinkConcreteStairs
 */
export type PinkConcreteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to PinkStainedGlassPane
 */
export type PinkStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to PinkWoolDoubleSlab
 */
export type PinkWoolDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to PinkWoolSlab
 */
export type PinkWoolSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to PinkWoolStairs
 */
export type PinkWoolStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type PolishedAndesiteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type PolishedBlackstoneBrickStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type PolishedBlackstoneStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type PolishedCinnabarStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type PolishedDeepslateStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type PolishedDioriteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type PolishedGraniteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type PolishedSulfurStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type PolishedTuffStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to PoplarButton
 */
export type PoplarButtonStates = Pick<BlockStateSuperset, 'button_pressed_bit' | 'facing_direction'>;
/**
 * States specific to PoplarDoor
 */
export type PoplarDoorStates = Pick<BlockStateSuperset, 'door_hinge_bit' | 'minecraft:cardinal_direction' | 'open_bit' | 'upper_block_bit'>;
/**
 * States specific to PoplarDoubleSlab
 */
export type PoplarDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to PoplarFence
 */
export type PoplarFenceStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to PoplarFenceGate
 */
export type PoplarFenceGateStates = Pick<BlockStateSuperset, 'in_wall_bit' | 'minecraft:cardinal_direction' | 'open_bit'>;
/**
 * States specific to PoplarHangingSign
 */
export type PoplarHangingSignStates = Pick<BlockStateSuperset, 'attached_bit' | 'facing_direction' | 'ground_sign_direction' | 'hanging'>;
/**
 * States specific to PoplarLog
 */
export type PoplarLogStates = Pick<BlockStateSuperset, 'pillar_axis'>;
/**
 * States specific to PoplarPressurePlate
 */
export type PoplarPressurePlateStates = Pick<BlockStateSuperset, 'redstone_signal'>;
/**
 * States specific to PoplarSapling
 */
export type PoplarSaplingStates = Pick<BlockStateSuperset, 'age_bit'>;
/**
 * States specific to PoplarShelf
 */
export type PoplarShelfStates = Pick<BlockStateSuperset, 'minecraft:cardinal_direction' | 'powered_bit' | 'powered_shelf_type'>;
/**
 * States specific to PoplarSlab
 */
export type PoplarSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to PoplarStairs
 */
export type PoplarStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 * States specific to PoplarStandingSign
 */
export type PoplarStandingSignStates = Pick<BlockStateSuperset, 'ground_sign_direction'>;
/**
 * States specific to PoplarTrapdoor
 */
export type PoplarTrapdoorStates = Pick<BlockStateSuperset, 'direction' | 'open_bit' | 'upside_down_bit'>;
/**
 * States specific to PoplarWallSign
 */
export type PoplarWallSignStates = Pick<BlockStateSuperset, 'facing_direction'>;
/**
 * States specific to PoplarWood
 */
export type PoplarWoodStates = Pick<BlockStateSuperset, 'pillar_axis'>;
/**
 ...
 */
export type PotentSulfurStates = Pick<BlockStateSuperset, 'potent_sulfur_state'>;
/**
 ...
 */
export type PrismarineBricksStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type PrismarineStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to PurpleConcreteDoubleSlab
 */
export type PurpleConcreteDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to PurpleConcreteSlab
 */
export type PurpleConcreteSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to PurpleConcreteStairs
 */
export type PurpleConcreteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to PurpleStainedGlassPane
 */
export type PurpleStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to PurpleWoolDoubleSlab
 */
export type PurpleWoolDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to PurpleWoolSlab
 */
export type PurpleWoolSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to PurpleWoolStairs
 */
export type PurpleWoolStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type PurpurStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type QuartzStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to RedConcreteDoubleSlab
 */
export type RedConcreteDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to RedConcreteSlab
 */
export type RedConcreteSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to RedConcreteStairs
 */
export type RedConcreteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type RedNetherBrickStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to RedPoplarLeaves
 */
export type RedPoplarLeavesStates = Pick<BlockStateSuperset, 'persistent_bit' | 'update_bit'>;
/**
 ...
 */
export type RedSandstoneStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to RedStainedGlassPane
 */
export type RedStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to RedWoolDoubleSlab
 */
export type RedWoolDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to RedWoolSlab
 */
export type RedWoolSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to RedWoolStairs
 */
export type RedWoolStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type RedstoneWireStates = Pick<BlockStateSuperset, 'redstone_east' | 'redstone_north' | 'redstone_signal' | 'redstone_south' | 'redstone_west'>;
/**
 ...
 */
export type ResinBrickStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type SandstoneStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to ShelfMushroom
 */
export type ShelfMushroomStates = Pick<BlockStateSuperset, 'growth' | 'minecraft:cardinal_direction'>;
/**
 ...
 */
export type SmoothQuartzStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type SmoothRedSandstoneStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type SmoothSandstoneStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to SpruceFence
 */
export type SpruceFenceStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 ...
 */
export type SpruceStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type StoneBrickStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type StoneStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to StrawBed
 */
export type StrawBedStates = Pick<BlockStateSuperset, 'head_piece_bit' | 'minecraft:cardinal_direction' | 'occupied_bit'>;
/**
...
/**
 * States specific to StrippedPoplarLog
 */
export type StrippedPoplarLogStates = Pick<BlockStateSuperset, 'pillar_axis'>;
/**
 * States specific to StrippedPoplarWood
 */
export type StrippedPoplarWoodStates = Pick<BlockStateSuperset, 'pillar_axis'>;
/**
 ...
 */
export type SulfurBrickStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type SulfurSpikeStates = Pick<BlockStateSuperset, 'dripstone_thickness' | 'hanging'>;
/**
 * States specific to SulfurStairs
 */
export type SulfurStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type TripWireStates = Pick<BlockStateSuperset, 'attached_bit' | 'disarmed_bit' | 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west' | 'powered_bit' | 'suspended_bit'>;
/**
 ...
 */
export type TuffBrickStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type TuffStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to WarpedFence
 */
export type WarpedFenceStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 ...
 */
export type WarpedStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to WaxedCopperBars
 */
export type WaxedCopperBarsStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 ...
 */
export type WaxedCutCopperStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to WaxedExposedCopperBars
 */
export type WaxedExposedCopperBarsStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 ...
 */
export type WaxedExposedCutCopperStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to WaxedOxidizedCopperBars
 */
export type WaxedOxidizedCopperBarsStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 ...
 */
export type WaxedOxidizedCutCopperStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to WaxedWeatheredCopperBars
 */
export type WaxedWeatheredCopperBarsStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 ...
 */
export type WaxedWeatheredCutCopperStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to WeatheredCopperBars
 */
export type WeatheredCopperBarsStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 ...
 */
export type WeatheredCutCopperStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to WhiteConcreteDoubleSlab
 */
export type WhiteConcreteDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to WhiteConcreteSlab
 */
export type WhiteConcreteSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to WhiteConcreteStairs
 */
export type WhiteConcreteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 * States specific to WhiteGlazedTerracotta
 */
export type WhiteGlazedTerracottaStates = Pick<BlockStateSuperset, 'facing_direction'>;
/**
 * States specific to WhiteStainedGlassPane
 */
export type WhiteStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to WhiteWoolDoubleSlab
 */
export type WhiteWoolDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to WhiteWoolSlab
 */
export type WhiteWoolSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to WhiteWoolStairs
 */
export type WhiteWoolStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to YellowConcreteDoubleSlab
 */
export type YellowConcreteDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to YellowConcreteSlab
 */
export type YellowConcreteSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to YellowConcreteStairs
 */
export type YellowConcreteStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
...
/**
 * States specific to YellowPoplarLeaves
 */
export type YellowPoplarLeavesStates = Pick<BlockStateSuperset, 'persistent_bit' | 'update_bit'>;
/**
 * States specific to YellowStainedGlassPane
 */
export type YellowStainedGlassPaneStates = Pick<BlockStateSuperset, 'minecraft:connection_east' | 'minecraft:connection_north' | 'minecraft:connection_south' | 'minecraft:connection_west'>;
/**
 * States specific to YellowWoolDoubleSlab
 */
export type YellowWoolDoubleSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to YellowWoolSlab
 */
export type YellowWoolSlabStates = Pick<BlockStateSuperset, 'minecraft:vertical_half'>;
/**
 * States specific to YellowWoolStairs
 */
export type YellowWoolStairsStates = Pick<BlockStateSuperset, 'minecraft:corner' | 'upside_down_bit' | 'weirdo_direction'>;
/**
 ...
 */
export type BlockStates = AcaciaButtonStates | AcaciaDoorStates | AcaciaDoubleSlabStates | AcaciaFenceStates | AcaciaFenceGateStates | AcaciaHangingSignStates | AcaciaLeavesStates | AcaciaLogStates | AcaciaPressurePlateStates | AcaciaSaplingStates | AcaciaShelfStates | AcaciaSlabStates | AcaciaStairsStates | AcaciaStandingSignStates | AcaciaTrapdoorStates | AcaciaWallSignStates | AcaciaWoodStates | ActivatorRailStates | AmethystClusterStates | AndesiteDoubleSlabStates | AndesiteSlabStates | AndesiteStairsStates | AndesiteWallStates | AnvilStates | AzaleaLeavesStates | AzaleaLeavesFloweredStates | BambooStates | BambooBlockStates | BambooButtonStates | BambooDoorStates | BambooDoubleSlabStates | BambooFenceStates | BambooFenceGateStates | BambooHangingSignStates | BambooMosaicDoubleSlabStates | BambooMosaicSlabStates | BambooMosaicStairsStates | BambooPressurePlateStates | BambooSaplingStates | BambooShelfStates | BambooSlabStates | BambooStairsStates | BambooStandingSignStates | BambooTrapdoorStates | BambooWallSignStates | BarrelStates | BasaltStates | BedStates | BedrockStates | BeeNestStates | BeehiveStates | BeetrootStates | BellStates | BigDripleafStates | BirchButtonStates | BirchDoorStates | BirchDoubleSlabStates | BirchFenceStates | BirchFenceGateStates | BirchHangingSignStates | BirchLeavesStates | BirchLogStates | BirchPressurePlateStates | BirchSaplingStates | BirchShelfStates | BirchSlabStates | BirchStairsStates | BirchStandingSignStates | BirchTrapdoorStates | BirchWallSignStates | BirchWoodStates | BlackCandleStates | BlackCandleCakeStates | BlackConcreteDoubleSlabStates | BlackConcreteSlabStates | BlackConcreteStairsStates | BlackGlazedTerracottaStates | BlackStainedGlassPaneStates | BlackWoolDoubleSlabStates | BlackWoolSlabStates | BlackWoolStairsStates | BlackstoneDoubleSlabStates | BlackstoneSlabStates | BlackstoneStairsStates | BlackstoneWallStates | BlastFurnaceStates | BlueCandleStates | BlueCandleCakeStates | BlueConcreteDoubleSlabStates | BlueConcreteSlabStates | BlueConcreteStairsStates | BlueGlazedTerracottaStates | BlueStainedGlassPaneStates | BlueWoolDoubleSlabStates | BlueWoolSlabStates | BlueWoolStairsStates | BoneBlockStates | BorderBlockStates | BrainCoralFanStates | BrainCoralWallFanStates | BrewingStandStates | BrickDoubleSlabStates | BrickSlabStates | BrickStairsStates | BrickWallStates | BrownCandleStates | BrownCandleCakeStates | BrownConcreteDoubleSlabStates | BrownConcreteSlabStates | BrownConcreteStairsStates | BrownGlazedTerracottaStates | BrownMushroomBlockStates | BrownStainedGlassPaneStates | BrownWoolDoubleSlabStates | BrownWoolSlabStates | BrownWoolStairsStates | BubbleColumnStates | BubbleCoralFanStates | BubbleCoralWallFanStates | CactusStates | CakeStates | CalibratedSculkSensorStates | CampfireStates | CandleStates | CandleCakeStates | CarrotsStates | CarvedPumpkinStates | CauldronStates | CaveVinesStates | CaveVinesBodyWithBerriesStates | CaveVinesHeadWithBerriesStates | ChainCommandBlockStates | CherryButtonStates | CherryDoorStates | CherryDoubleSlabStates | CherryFenceStates | CherryFenceGateStates | CherryHangingSignStates | CherryLeavesStates | CherryLogStates | CherryPressurePlateStates | CherrySaplingStates | CherryShelfStates | CherrySlabStates | CherryStairsStates | CherryStandingSignStates | CherryTrapdoorStates | CherryWallSignStates | CherryWoodStates | ChestStates | ChippedAnvilStates | ChiseledBookshelfStates | ChiseledQuartzBlockStates | ChorusFlowerStates | ChorusPlantStates | CinnabarBrickDoubleSlabStates | CinnabarBrickSlabStates | CinnabarBrickStairsStates | CinnabarBrickWallStates | CinnabarDoubleSlabStates | CinnabarSlabStates | CinnabarStairsStates | CinnabarWallStates | CobbledDeepslateDoubleSlabStates | CobbledDeepslateSlabStates | CobbledDeepslateStairsStates | CobbledDeepslateWallStates | CobblestoneDoubleSlabStates | CobblestoneSlabStates | CobblestoneWallStates | CocoaStates | ColoredTorchBlueStates | ColoredTorchGreenStates | ColoredTorchPurpleStates | ColoredTorchRedStates | CommandBlockStates | ComposterStates | CompoundCreatorStates | CopperBarsStates | CopperBulbStates | CopperChainStates | CopperChestStates | CopperDoorStates | CopperGolemStatueStates | CopperLanternStates | CopperTorchStates | CopperTrapdoorStates | CrafterStates | CreakingHeartStates | CreeperHeadStates | CrimsonButtonStates | CrimsonDoorStates | CrimsonDoubleSlabStates | CrimsonFenceStates | CrimsonFenceGateStates | CrimsonHangingSignStates | CrimsonHyphaeStates | CrimsonPressurePlateStates | CrimsonShelfStates | CrimsonSlabStates | CrimsonStairsStates | CrimsonStandingSignStates | CrimsonStemStates | CrimsonTrapdoorStates | CrimsonWallSignStates | CutCopperSlabStates | CutCopperStairsStates | CutRedSandstoneDoubleSlabStates | CutRedSandstoneSlabStates | CutSandstoneDoubleSlabStates | CutSandstoneSlabStates | CyanCandleStates | CyanCandleCakeStates | CyanConcreteDoubleSlabStates | CyanConcreteSlabStates | CyanConcreteStairsStates | CyanGlazedTerracottaStates | CyanStainedGlassPaneStates | CyanWoolDoubleSlabStates | CyanWoolSlabStates | CyanWoolStairsStates | DamagedAnvilStates | DarkOakButtonStates | DarkOakDoorStates | DarkOakDoubleSlabStates | DarkOakFenceStates | DarkOakFenceGateStates | DarkOakHangingSignStates | DarkOakLeavesStates | DarkOakLogStates | DarkOakPressurePlateStates | DarkOakSaplingStates | DarkOakShelfStates | DarkOakSlabStates | DarkOakStairsStates | DarkOakTrapdoorStates | DarkOakWoodStates | DarkPrismarineDoubleSlabStates | DarkPrismarineSlabStates | DarkPrismarineStairsStates | DarkoakStandingSignStates | DarkoakWallSignStates | DaylightDetectorStates | DaylightDetectorInvertedStates | DeadBrainCoralFanStates | DeadBrainCoralWallFanStates | DeadBubbleCoralFanStates | DeadBubbleCoralWallFanStates | DeadFireCoralFanStates | DeadFireCoralWallFanStates | DeadHornCoralFanStates | DeadHornCoralWallFanStates | DeadTubeCoralFanStates | DeadTubeCoralWallFanStates | DecoratedPotStates | DeepslateStates | DeepslateBrickDoubleSlabStates | DeepslateBrickSlabStates | DeepslateBrickStairsStates | DeepslateBrickWallStates | DeepslateTileDoubleSlabStates | DeepslateTileSlabStates | DeepslateTileStairsStates | DeepslateTileWallStates | DetectorRailStates | DioriteDoubleSlabStates | DioriteSlabStates | DioriteStairsStates | DioriteWallStates | DispenserStates | DoubleCutCopperSlabStates | DragonHeadStates | DriedGhastStates | DropperStates | ElementConstructorStates | EndBrickStairsStates | EndPortalFrameStates | EndRodStates | EndStoneBrickDoubleSlabStates | EndStoneBrickSlabStates | EndStoneBrickWallStates | EnderChestStates | ExposedCopperBarsStates | ExposedCopperBulbStates | ExposedCopperChainStates | ExposedCopperChestStates | ExposedCopperDoorStates | ExposedCopperGolemStatueStates | ExposedCopperLanternStates | ExposedCopperTrapdoorStates | ExposedCutCopperSlabStates | ExposedCutCopperStairsStates | ExposedDoubleCutCopperSlabStates | ExposedLightningRodStates | FarmlandStates | FenceGateStates | FireStates | FireCoralFanStates | FireCoralWallFanStates | FlowerPotStates | FlowingLavaStates | FlowingWaterStates | FrameStates | FrostedIceStates | FurnaceStates | GlassPaneStates | GlowFrameStates | GlowLichenStates | GoldenRailStates | GraniteDoubleSlabStates | GraniteSlabStates | GraniteStairsStates | GraniteWallStates | GrayCandleStates | GrayCandleCakeStates | GrayConcreteDoubleSlabStates | GrayConcreteSlabStates | GrayConcreteStairsStates | GrayGlazedTerracottaStates | GrayStainedGlassPaneStates | GrayWoolDoubleSlabStates | GrayWoolSlabStates | GrayWoolStairsStates | GreenCandleStates | GreenCandleCakeStates | GreenConcreteDoubleSlabStates | GreenConcreteSlabStates | GreenConcreteStairsStates | GreenGlazedTerracottaStates | GreenStainedGlassPaneStates | GreenWoolDoubleSlabStates | GreenWoolSlabStates | GreenWoolStairsStates | GrindstoneStates | HardBlackStainedGlassPaneStates | HardBlueStainedGlassPaneStates | HardBrownStainedGlassPaneStates | HardCyanStainedGlassPaneStates | HardGlassPaneStates | HardGrayStainedGlassPaneStates | HardGreenStainedGlassPaneStates | HardLightBlueStainedGlassPaneStates | HardLightGrayStainedGlassPaneStates | HardLimeStainedGlassPaneStates | HardMagentaStainedGlassPaneStates | HardOrangeStainedGlassPaneStates | HardPinkStainedGlassPaneStates | HardPurpleStainedGlassPaneStates | HardRedStainedGlassPaneStates | HardWhiteStainedGlassPaneStates | HardYellowStainedGlassPaneStates | HayBlockStates | HeavyWeightedPressurePlateStates | HopperStates | HornCoralFanStates | HornCoralWallFanStates | InfestedDeepslateStates | IronBarsStates | IronChainStates | IronDoorStates | IronTrapdoorStates | JigsawStates | JungleButtonStates | JungleDoorStates | JungleDoubleSlabStates | JungleFenceStates | JungleFenceGateStates | JungleHangingSignStates | JungleLeavesStates | JungleLogStates | JunglePressurePlateStates | JungleSaplingStates | JungleShelfStates | JungleSlabStates | JungleStairsStates | JungleStandingSignStates | JungleTrapdoorStates | JungleWallSignStates | JungleWoodStates | KelpStates | LabTableStates | LadderStates | LanternStates | LargeAmethystBudStates | LargeFernStates | LavaStates | LeafLitterStates | LecternStates | LeverStates | LightBlueCandleStates | LightBlueCandleCakeStates | LightBlueConcreteDoubleSlabStates | LightBlueConcreteSlabStates | LightBlueConcreteStairsStates | LightBlueGlazedTerracottaStates | LightBlueStainedGlassPaneStates | LightBlueWoolDoubleSlabStates | LightBlueWoolSlabStates | LightBlueWoolStairsStates | LightGrayCandleStates | LightGrayCandleCakeStates | LightGrayConcreteDoubleSlabStates | LightGrayConcreteSlabStates | LightGrayConcreteStairsStates | LightGrayStainedGlassPaneStates | LightGrayWoolDoubleSlabStates | LightGrayWoolSlabStates | LightGrayWoolStairsStates | LightWeightedPressurePlateStates | LightningRodStates | LilacStates | LimeCandleStates | LimeCandleCakeStates | LimeConcreteDoubleSlabStates | LimeConcreteSlabStates | LimeConcreteStairsStates | LimeGlazedTerracottaStates | LimeStainedGlassPaneStates | LimeWoolDoubleSlabStates | LimeWoolSlabStates | LimeWoolStairsStates | LitBlastFurnaceStates | LitFurnaceStates | LitPumpkinStates | LitSmokerStates | LoomStates | MagentaCandleStates | MagentaCandleCakeStates | MagentaConcreteDoubleSlabStates | MagentaConcreteSlabStates | MagentaConcreteStairsStates | MagentaGlazedTerracottaStates | MagentaStainedGlassPaneStates | MagentaWoolDoubleSlabStates | MagentaWoolSlabStates | MagentaWoolStairsStates | MangroveButtonStates | MangroveDoorStates | MangroveDoubleSlabStates | MangroveFenceStates | MangroveFenceGateStates | MangroveHangingSignStates | MangroveLeavesStates | MangroveLogStates | MangrovePressurePlateStates | MangrovePropaguleStates | MangroveShelfStates | MangroveSlabStates | MangroveStairsStates | MangroveStandingSignStates | MangroveTrapdoorStates | MangroveWallSignStates | MangroveWoodStates | MaterialReducerStates | MediumAmethystBudStates | MelonStemStates | MossyCobblestoneDoubleSlabStates | MossyCobblestoneSlabStates | MossyCobblestoneStairsStates | MossyCobblestoneWallStates | MossyStoneBrickDoubleSlabStates | MossyStoneBrickSlabStates | MossyStoneBrickStairsStates | MossyStoneBrickWallStates | MudBrickDoubleSlabStates | MudBrickSlabStates | MudBrickStairsStates | MudBrickWallStates | MuddyMangroveRootsStates | MushroomStemStates | NetherBrickDoubleSlabStates | NetherBrickFenceStates | NetherBrickSlabStates | NetherBrickStairsStates | NetherBrickWallStates | NetherWartStates | NormalStoneDoubleSlabStates | NormalStoneSlabStates | NormalStoneStairsStates | OakDoubleSlabStates | OakFenceStates | OakHangingSignStates | OakLeavesStates | OakLogStates | OakSaplingStates | OakShelfStates | OakSlabStates | OakStairsStates | OakWoodStates | ObserverStates | OchreFroglightStates | OrangeCandleStates | OrangeCandleCakeStates | OrangeConcreteDoubleSlabStates | OrangeConcreteSlabStates | OrangeConcreteStairsStates | OrangeGlazedTerracottaStates | OrangePoplarLeavesStates | OrangeStainedGlassPaneStates | OrangeWoolDoubleSlabStates | OrangeWoolSlabStates | OrangeWoolStairsStates | OxidizedCopperBarsStates | OxidizedCopperBulbStates | OxidizedCopperChainStates | OxidizedCopperChestStates | OxidizedCopperDoorStates | OxidizedCopperGolemStatueStates | OxidizedCopperLanternStates | OxidizedCopperTrapdoorStates | OxidizedCutCopperSlabStates | OxidizedCutCopperStairsStates | OxidizedDoubleCutCopperSlabStates | OxidizedLightningRodStates | PaleHangingMossStates | PaleMossCarpetStates | PaleOakButtonStates | PaleOakDoorStates | PaleOakDoubleSlabStates | PaleOakFenceStates | PaleOakFenceGateStates | PaleOakHangingSignStates | PaleOakLeavesStates | PaleOakLogStates | PaleOakPressurePlateStates | PaleOakSaplingStates | PaleOakShelfStates | PaleOakSlabStates | PaleOakStairsStates | PaleOakStandingSignStates | PaleOakTrapdoorStates | PaleOakWallSignStates | PaleOakWoodStates | PearlescentFroglightStates | PeonyStates | PetrifiedOakDoubleSlabStates | PetrifiedOakSlabStates | PiglinHeadStates | PinkCandleStates | PinkCandleCakeStates | PinkConcreteDoubleSlabStates | PinkConcreteSlabStates | PinkConcreteStairsStates | PinkGlazedTerracottaStates | PinkPetalsStates | PinkStainedGlassPaneStates | PinkWoolDoubleSlabStates | PinkWoolSlabStates | PinkWoolStairsStates | PistonStates | PistonArmCollisionStates | PitcherCropStates | PitcherPlantStates | PlayerHeadStates | PointedDripstoneStates | PolishedAndesiteDoubleSlabStates | PolishedAndesiteSlabStates | PolishedAndesiteStairsStates | PolishedBasaltStates | PolishedBlackstoneBrickDoubleSlabStates | PolishedBlackstoneBrickSlabStates | PolishedBlackstoneBrickStairsStates | PolishedBlackstoneBrickWallStates | PolishedBlackstoneButtonStates | PolishedBlackstoneDoubleSlabStates | PolishedBlackstonePressurePlateStates | PolishedBlackstoneSlabStates | PolishedBlackstoneStairsStates | PolishedBlackstoneWallStates | PolishedCinnabarDoubleSlabStates | PolishedCinnabarSlabStates | PolishedCinnabarStairsStates | PolishedCinnabarWallStates | PolishedDeepslateDoubleSlabStates | PolishedDeepslateSlabStates | PolishedDeepslateStairsStates | PolishedDeepslateWallStates | PolishedDioriteDoubleSlabStates | PolishedDioriteSlabStates | PolishedDioriteStairsStates | PolishedGraniteDoubleSlabStates | PolishedGraniteSlabStates | PolishedGraniteStairsStates | PolishedSulfurDoubleSlabStates | PolishedSulfurSlabStates | PolishedSulfurStairsStates | PolishedSulfurWallStates | PolishedTuffDoubleSlabStates | PolishedTuffSlabStates | PolishedTuffStairsStates | PolishedTuffWallStates | PoplarButtonStates | PoplarDoorStates | PoplarDoubleSlabStates | PoplarFenceStates | PoplarFenceGateStates | PoplarHangingSignStates | PoplarLogStates | PoplarPressurePlateStates | PoplarSaplingStates | PoplarShelfStates | PoplarSlabStates | PoplarStairsStates | PoplarStandingSignStates | PoplarTrapdoorStates | PoplarWallSignStates | PoplarWoodStates | PortalStates | PotatoesStates | PotentSulfurStates | PoweredComparatorStates | PoweredRepeaterStates | PrismarineBrickDoubleSlabStates | PrismarineBrickSlabStates | PrismarineBricksStairsStates | PrismarineDoubleSlabStates | PrismarineSlabStates | PrismarineStairsStates | PrismarineWallStates | PumpkinStates | PumpkinStemStates | PurpleCandleStates | PurpleCandleCakeStates | PurpleConcreteDoubleSlabStates | PurpleConcreteSlabStates | PurpleConcreteStairsStates | PurpleGlazedTerracottaStates | PurpleStainedGlassPaneStates | PurpleWoolDoubleSlabStates | PurpleWoolSlabStates | PurpleWoolStairsStates | PurpurBlockStates | PurpurDoubleSlabStates | PurpurPillarStates | PurpurSlabStates | PurpurStairsStates | QuartzBlockStates | QuartzDoubleSlabStates | QuartzPillarStates | QuartzSlabStates | QuartzStairsStates | RailStates | RedCandleStates | RedCandleCakeStates | RedConcreteDoubleSlabStates | RedConcreteSlabStates | RedConcreteStairsStates | RedGlazedTerracottaStates | RedMushroomBlockStates | RedNetherBrickDoubleSlabStates | RedNetherBrickSlabStates | RedNetherBrickStairsStates | RedNetherBrickWallStates | RedPoplarLeavesStates | RedSandstoneDoubleSlabStates | RedSandstoneSlabStates | RedSandstoneStairsStates | RedSandstoneWallStates | RedStainedGlassPaneStates | RedWoolDoubleSlabStates | RedWoolSlabStates | RedWoolStairsStates | RedstoneTorchStates | RedstoneWireStates | ReedsStates | RepeatingCommandBlockStates | ResinBrickDoubleSlabStates | ResinBrickSlabStates | ResinBrickStairsStates | ResinBrickWallStates | ResinClumpStates | RespawnAnchorStates | RoseBushStates | SandstoneDoubleSlabStates | SandstoneSlabStates | SandstoneStairsStates | SandstoneWallStates | ScaffoldingStates | SculkCatalystStates | SculkSensorStates | SculkShriekerStates | SculkVeinStates | SeaPickleStates | SeagrassStates | ShelfMushroomStates | SilverGlazedTerracottaStates | SkeletonSkullStates | SmallAmethystBudStates | SmallDripleafBlockStates | SmokerStates | SmoothQuartzStates | SmoothQuartzDoubleSlabStates | SmoothQuartzSlabStates | SmoothQuartzStairsStates | SmoothRedSandstoneDoubleSlabStates | SmoothRedSandstoneSlabStates | SmoothRedSandstoneStairsStates | SmoothSandstoneDoubleSlabStates | SmoothSandstoneSlabStates | SmoothSandstoneStairsStates | SmoothStoneDoubleSlabStates | SmoothStoneSlabStates | SnifferEggStates | SnowLayerStates | SoulCampfireStates | SoulFireStates | SoulLanternStates | SoulTorchStates | SpruceButtonStates | SpruceDoorStates | SpruceDoubleSlabStates | SpruceFenceStates | SpruceFenceGateStates | SpruceHangingSignStates | SpruceLeavesStates | SpruceLogStates | SprucePressurePlateStates | SpruceSaplingStates | SpruceShelfStates | SpruceSlabStates | SpruceStairsStates | SpruceStandingSignStates | SpruceTrapdoorStates | SpruceWallSignStates | SpruceWoodStates | StandingBannerStates | StandingSignStates | StickyPistonStates | StickyPistonArmCollisionStates | StoneBrickDoubleSlabStates | StoneBrickSlabStates | StoneBrickStairsStates | StoneBrickWallStates | StoneButtonStates | StonePressurePlateStates | StoneStairsStates | StonecutterBlockStates | StrawBedStates | StrippedAcaciaLogStates | StrippedAcaciaWoodStates | StrippedBambooBlockStates | StrippedBirchLogStates | StrippedBirchWoodStates | StrippedCherryLogStates | StrippedCherryWoodStates | StrippedCrimsonHyphaeStates | StrippedCrimsonStemStates | StrippedDarkOakLogStates | StrippedDarkOakWoodStates | StrippedJungleLogStates | StrippedJungleWoodStates | StrippedMangroveLogStates | StrippedMangroveWoodStates | StrippedOakLogStates | StrippedOakWoodStates | StrippedPaleOakLogStates | StrippedPaleOakWoodStates | StrippedPoplarLogStates | StrippedPoplarWoodStates | StrippedSpruceLogStates | StrippedSpruceWoodStates | StrippedWarpedHyphaeStates | StrippedWarpedStemStates | StructureBlockStates | SulfurBrickDoubleSlabStates | SulfurBrickSlabStates | SulfurBrickStairsStates | SulfurBrickWallStates | SulfurDoubleSlabStates | SulfurSlabStates | SulfurSpikeStates | SulfurStairsStates | SulfurWallStates | SunflowerStates | SuspiciousGravelStates | SuspiciousSandStates | SweetBerryBushStates | TallGrassStates | TntStates | TorchStates | TorchflowerCropStates | TrapdoorStates | TrappedChestStates | TrialSpawnerStates | TripWireStates | TripwireHookStates | TubeCoralFanStates | TubeCoralWallFanStates | TuffBrickDoubleSlabStates | TuffBrickSlabStates | TuffBrickStairsStates | TuffBrickWallStates | TuffDoubleSlabStates | TuffSlabStates | TuffStairsStates | TuffWallStates | TurtleEggStates | TwistingVinesStates | UnderwaterTntStates | UnderwaterTorchStates | UnlitRedstoneTorchStates | UnpoweredComparatorStates | UnpoweredRepeaterStates | VaultStates | VerdantFroglightStates | VineStates | WallBannerStates | WallSignStates | WarpedButtonStates | WarpedDoorStates | WarpedDoubleSlabStates | WarpedFenceStates | WarpedFenceGateStates | WarpedHangingSignStates | WarpedHyphaeStates | WarpedPressurePlateStates | WarpedShelfStates | WarpedSlabStates | WarpedStairsStates | WarpedStandingSignStates | WarpedStemStates | WarpedTrapdoorStates | WarpedWallSignStates | WaterStates | WaxedCopperBarsStates | WaxedCopperBulbStates | WaxedCopperChainStates | WaxedCopperChestStates | WaxedCopperDoorStates | WaxedCopperGolemStatueStates | WaxedCopperLanternStates | WaxedCopperTrapdoorStates | WaxedCutCopperSlabStates | WaxedCutCopperStairsStates | WaxedDoubleCutCopperSlabStates | WaxedExposedCopperBarsStates | WaxedExposedCopperBulbStates | WaxedExposedCopperChainStates | WaxedExposedCopperChestStates | WaxedExposedCopperDoorStates | WaxedExposedCopperGolemStatueStates | WaxedExposedCopperLanternStates | WaxedExposedCopperTrapdoorStates | WaxedExposedCutCopperSlabStates | WaxedExposedCutCopperStairsStates | WaxedExposedDoubleCutCopperSlabStates | WaxedExposedLightningRodStates | WaxedLightningRodStates | WaxedOxidizedCopperBarsStates | WaxedOxidizedCopperBulbStates | WaxedOxidizedCopperChainStates | WaxedOxidizedCopperChestStates | WaxedOxidizedCopperDoorStates | WaxedOxidizedCopperGolemStatueStates | WaxedOxidizedCopperLanternStates | WaxedOxidizedCopperTrapdoorStates | WaxedOxidizedCutCopperSlabStates | WaxedOxidizedCutCopperStairsStates | WaxedOxidizedDoubleCutCopperSlabStates | WaxedOxidizedLightningRodStates | WaxedWeatheredCopperBarsStates | WaxedWeatheredCopperBulbStates | WaxedWeatheredCopperChainStates | WaxedWeatheredCopperChestStates | WaxedWeatheredCopperDoorStates | WaxedWeatheredCopperGolemStatueStates | WaxedWeatheredCopperLanternStates | WaxedWeatheredCopperTrapdoorStates | WaxedWeatheredCutCopperSlabStates | WaxedWeatheredCutCopperStairsStates | WaxedWeatheredDoubleCutCopperSlabStates | WaxedWeatheredLightningRodStates | WeatheredCopperBarsStates | WeatheredCopperBulbStates | WeatheredCopperChainStates | WeatheredCopperChestStates | WeatheredCopperDoorStates | WeatheredCopperGolemStatueStates | WeatheredCopperLanternStates | WeatheredCopperTrapdoorStates | WeatheredCutCopperSlabStates | WeatheredCutCopperStairsStates | WeatheredDoubleCutCopperSlabStates | WeatheredLightningRodStates | WeepingVinesStates | WheatStates | WhiteCandleStates | WhiteCandleCakeStates | WhiteConcreteDoubleSlabStates | WhiteConcreteSlabStates | WhiteConcreteStairsStates | WhiteGlazedTerracottaStates | WhiteStainedGlassPaneStates | WhiteWoolDoubleSlabStates | WhiteWoolSlabStates | WhiteWoolStairsStates | WildflowersStates | WitherSkeletonSkullStates | WoodenButtonStates | WoodenDoorStates | WoodenPressurePlateStates | YellowCandleStates | YellowCandleCakeStates | YellowConcreteDoubleSlabStates | YellowConcreteSlabStates | YellowConcreteStairsStates | YellowGlazedTerracottaStates | YellowPoplarLeavesStates | YellowStainedGlassPaneStates | YellowWoolDoubleSlabStates | YellowWoolSlabStates | YellowWoolStairsStates | ZombieHeadStates;
/**
...
export type BlockStateMapping = {
    ...
    acacia_fence: AcaciaFenceStates;
    'minecraft:acacia_fence': AcaciaFenceStates;
    ...
    bamboo_fence: BambooFenceStates;
    'minecraft:bamboo_fence': BambooFenceStates;
    ...
    birch_fence: BirchFenceStates;
    'minecraft:birch_fence': BirchFenceStates;
    ...
    black_concrete_double_slab: BlackConcreteDoubleSlabStates;
    'minecraft:black_concrete_double_slab': BlackConcreteDoubleSlabStates;
    black_concrete_slab: BlackConcreteSlabStates;
    'minecraft:black_concrete_slab': BlackConcreteSlabStates;
    black_concrete_stairs: BlackConcreteStairsStates;
    'minecraft:black_concrete_stairs': BlackConcreteStairsStates;
    black_glazed_terracotta: BlackGlazedTerracottaStates;
    'minecraft:black_glazed_terracotta': BlackGlazedTerracottaStates;
    black_stained_glass_pane: BlackStainedGlassPaneStates;
    'minecraft:black_stained_glass_pane': BlackStainedGlassPaneStates;
    black_wool_double_slab: BlackWoolDoubleSlabStates;
    'minecraft:black_wool_double_slab': BlackWoolDoubleSlabStates;
    black_wool_slab: BlackWoolSlabStates;
    'minecraft:black_wool_slab': BlackWoolSlabStates;
    black_wool_stairs: BlackWoolStairsStates;
    'minecraft:black_wool_stairs': BlackWoolStairsStates;
    ...
    blue_concrete_double_slab: BlueConcreteDoubleSlabStates;
    'minecraft:blue_concrete_double_slab': BlueConcreteDoubleSlabStates;
    blue_concrete_slab: BlueConcreteSlabStates;
    'minecraft:blue_concrete_slab': BlueConcreteSlabStates;
    blue_concrete_stairs: BlueConcreteStairsStates;
    'minecraft:blue_concrete_stairs': BlueConcreteStairsStates;
    blue_glazed_terracotta: BlueGlazedTerracottaStates;
    'minecraft:blue_glazed_terracotta': BlueGlazedTerracottaStates;
    blue_stained_glass_pane: BlueStainedGlassPaneStates;
    'minecraft:blue_stained_glass_pane': BlueStainedGlassPaneStates;
    blue_wool_double_slab: BlueWoolDoubleSlabStates;
    'minecraft:blue_wool_double_slab': BlueWoolDoubleSlabStates;
    blue_wool_slab: BlueWoolSlabStates;
    'minecraft:blue_wool_slab': BlueWoolSlabStates;
    blue_wool_stairs: BlueWoolStairsStates;
    'minecraft:blue_wool_stairs': BlueWoolStairsStates;
    ...
    brown_concrete_double_slab: BrownConcreteDoubleSlabStates;
    'minecraft:brown_concrete_double_slab': BrownConcreteDoubleSlabStates;
    brown_concrete_slab: BrownConcreteSlabStates;
    'minecraft:brown_concrete_slab': BrownConcreteSlabStates;
    brown_concrete_stairs: BrownConcreteStairsStates;
    'minecraft:brown_concrete_stairs': BrownConcreteStairsStates;
    ...
    brown_stained_glass_pane: BrownStainedGlassPaneStates;
    'minecraft:brown_stained_glass_pane': BrownStainedGlassPaneStates;
    brown_wool_double_slab: BrownWoolDoubleSlabStates;
    'minecraft:brown_wool_double_slab': BrownWoolDoubleSlabStates;
    brown_wool_slab: BrownWoolSlabStates;
    'minecraft:brown_wool_slab': BrownWoolSlabStates;
    brown_wool_stairs: BrownWoolStairsStates;
    'minecraft:brown_wool_stairs': BrownWoolStairsStates;
    ...
    cherry_fence: CherryFenceStates;
    'minecraft:cherry_fence': CherryFenceStates;
    ...
    chorus_plant: ChorusPlantStates;
    'minecraft:chorus_plant': ChorusPlantStates;
    ...
    copper_bars: CopperBarsStates;
    'minecraft:copper_bars': CopperBarsStates;
    ...
    crimson_fence: CrimsonFenceStates;
    'minecraft:crimson_fence': CrimsonFenceStates;
    ...
    cyan_concrete_double_slab: CyanConcreteDoubleSlabStates;
    'minecraft:cyan_concrete_double_slab': CyanConcreteDoubleSlabStates;
    cyan_concrete_slab: CyanConcreteSlabStates;
    'minecraft:cyan_concrete_slab': CyanConcreteSlabStates;
    cyan_concrete_stairs: CyanConcreteStairsStates;
    'minecraft:cyan_concrete_stairs': CyanConcreteStairsStates;
    cyan_glazed_terracotta: CyanGlazedTerracottaStates;
    'minecraft:cyan_glazed_terracotta': CyanGlazedTerracottaStates;
    cyan_stained_glass_pane: CyanStainedGlassPaneStates;
    'minecraft:cyan_stained_glass_pane': CyanStainedGlassPaneStates;
    cyan_wool_double_slab: CyanWoolDoubleSlabStates;
    'minecraft:cyan_wool_double_slab': CyanWoolDoubleSlabStates;
    cyan_wool_slab: CyanWoolSlabStates;
    'minecraft:cyan_wool_slab': CyanWoolSlabStates;
    cyan_wool_stairs: CyanWoolStairsStates;
    'minecraft:cyan_wool_stairs': CyanWoolStairsStates;
    ...
    dark_oak_fence: DarkOakFenceStates;
    'minecraft:dark_oak_fence': DarkOakFenceStates;
    ...
    exposed_copper_bars: ExposedCopperBarsStates;
    'minecraft:exposed_copper_bars': ExposedCopperBarsStates;
    ...
    glass_pane: GlassPaneStates;
    'minecraft:glass_pane': GlassPaneStates;
    ...
    gray_concrete_double_slab: GrayConcreteDoubleSlabStates;
    'minecraft:gray_concrete_double_slab': GrayConcreteDoubleSlabStates;
    gray_concrete_slab: GrayConcreteSlabStates;
    'minecraft:gray_concrete_slab': GrayConcreteSlabStates;
    gray_concrete_stairs: GrayConcreteStairsStates;
    'minecraft:gray_concrete_stairs': GrayConcreteStairsStates;
    gray_glazed_terracotta: GrayGlazedTerracottaStates;
    'minecraft:gray_glazed_terracotta': GrayGlazedTerracottaStates;
    gray_stained_glass_pane: GrayStainedGlassPaneStates;
    'minecraft:gray_stained_glass_pane': GrayStainedGlassPaneStates;
    gray_wool_double_slab: GrayWoolDoubleSlabStates;
    'minecraft:gray_wool_double_slab': GrayWoolDoubleSlabStates;
    gray_wool_slab: GrayWoolSlabStates;
    'minecraft:gray_wool_slab': GrayWoolSlabStates;
    gray_wool_stairs: GrayWoolStairsStates;
    'minecraft:gray_wool_stairs': GrayWoolStairsStates;
    ...
    green_concrete_double_slab: GreenConcreteDoubleSlabStates;
    'minecraft:green_concrete_double_slab': GreenConcreteDoubleSlabStates;
    green_concrete_slab: GreenConcreteSlabStates;
    'minecraft:green_concrete_slab': GreenConcreteSlabStates;
    green_concrete_stairs: GreenConcreteStairsStates;
    'minecraft:green_concrete_stairs': GreenConcreteStairsStates;
    green_glazed_terracotta: GreenGlazedTerracottaStates;
    'minecraft:green_glazed_terracotta': GreenGlazedTerracottaStates;
    green_stained_glass_pane: GreenStainedGlassPaneStates;
    'minecraft:green_stained_glass_pane': GreenStainedGlassPaneStates;
    green_wool_double_slab: GreenWoolDoubleSlabStates;
    'minecraft:green_wool_double_slab': GreenWoolDoubleSlabStates;
    green_wool_slab: GreenWoolSlabStates;
    'minecraft:green_wool_slab': GreenWoolSlabStates;
    green_wool_stairs: GreenWoolStairsStates;
    'minecraft:green_wool_stairs': GreenWoolStairsStates;
    grindstone: GrindstoneStates;
    'minecraft:grindstone': GrindstoneStates;
    hard_black_stained_glass_pane: HardBlackStainedGlassPaneStates;
    'minecraft:hard_black_stained_glass_pane': HardBlackStainedGlassPaneStates;
    hard_blue_stained_glass_pane: HardBlueStainedGlassPaneStates;
    'minecraft:hard_blue_stained_glass_pane': HardBlueStainedGlassPaneStates;
    hard_brown_stained_glass_pane: HardBrownStainedGlassPaneStates;
    'minecraft:hard_brown_stained_glass_pane': HardBrownStainedGlassPaneStates;
    hard_cyan_stained_glass_pane: HardCyanStainedGlassPaneStates;
    'minecraft:hard_cyan_stained_glass_pane': HardCyanStainedGlassPaneStates;
    hard_glass_pane: HardGlassPaneStates;
    'minecraft:hard_glass_pane': HardGlassPaneStates;
    hard_gray_stained_glass_pane: HardGrayStainedGlassPaneStates;
    'minecraft:hard_gray_stained_glass_pane': HardGrayStainedGlassPaneStates;
    hard_green_stained_glass_pane: HardGreenStainedGlassPaneStates;
    'minecraft:hard_green_stained_glass_pane': HardGreenStainedGlassPaneStates;
    hard_light_blue_stained_glass_pane: HardLightBlueStainedGlassPaneStates;
    'minecraft:hard_light_blue_stained_glass_pane': HardLightBlueStainedGlassPaneStates;
    hard_light_gray_stained_glass_pane: HardLightGrayStainedGlassPaneStates;
    'minecraft:hard_light_gray_stained_glass_pane': HardLightGrayStainedGlassPaneStates;
    hard_lime_stained_glass_pane: HardLimeStainedGlassPaneStates;
    'minecraft:hard_lime_stained_glass_pane': HardLimeStainedGlassPaneStates;
    hard_magenta_stained_glass_pane: HardMagentaStainedGlassPaneStates;
    'minecraft:hard_magenta_stained_glass_pane': HardMagentaStainedGlassPaneStates;
    hard_orange_stained_glass_pane: HardOrangeStainedGlassPaneStates;
    'minecraft:hard_orange_stained_glass_pane': HardOrangeStainedGlassPaneStates;
    hard_pink_stained_glass_pane: HardPinkStainedGlassPaneStates;
    'minecraft:hard_pink_stained_glass_pane': HardPinkStainedGlassPaneStates;
    hard_purple_stained_glass_pane: HardPurpleStainedGlassPaneStates;
    'minecraft:hard_purple_stained_glass_pane': HardPurpleStainedGlassPaneStates;
    hard_red_stained_glass_pane: HardRedStainedGlassPaneStates;
    'minecraft:hard_red_stained_glass_pane': HardRedStainedGlassPaneStates;
    hard_white_stained_glass_pane: HardWhiteStainedGlassPaneStates;
    'minecraft:hard_white_stained_glass_pane': HardWhiteStainedGlassPaneStates;
    hard_yellow_stained_glass_pane: HardYellowStainedGlassPaneStates;
    'minecraft:hard_yellow_stained_glass_pane': HardYellowStainedGlassPaneStates;
    ...
    iron_bars: IronBarsStates;
    'minecraft:iron_bars': IronBarsStates;
    ...
    jungle_fence: JungleFenceStates;
    'minecraft:jungle_fence': JungleFenceStates;
    ...
    light_blue_concrete_double_slab: LightBlueConcreteDoubleSlabStates;
    'minecraft:light_blue_concrete_double_slab': LightBlueConcreteDoubleSlabStates;
    light_blue_concrete_slab: LightBlueConcreteSlabStates;
    'minecraft:light_blue_concrete_slab': LightBlueConcreteSlabStates;
    light_blue_concrete_stairs: LightBlueConcreteStairsStates;
    'minecraft:light_blue_concrete_stairs': LightBlueConcreteStairsStates;
    ...
    light_blue_stained_glass_pane: LightBlueStainedGlassPaneStates;
    'minecraft:light_blue_stained_glass_pane': LightBlueStainedGlassPaneStates;
    light_blue_wool_double_slab: LightBlueWoolDoubleSlabStates;
    'minecraft:light_blue_wool_double_slab': LightBlueWoolDoubleSlabStates;
    light_blue_wool_slab: LightBlueWoolSlabStates;
    'minecraft:light_blue_wool_slab': LightBlueWoolSlabStates;
    light_blue_wool_stairs: LightBlueWoolStairsStates;
    'minecraft:light_blue_wool_stairs': LightBlueWoolStairsStates;
    ...
    light_gray_concrete_double_slab: LightGrayConcreteDoubleSlabStates;
    'minecraft:light_gray_concrete_double_slab': LightGrayConcreteDoubleSlabStates;
    light_gray_concrete_slab: LightGrayConcreteSlabStates;
    'minecraft:light_gray_concrete_slab': LightGrayConcreteSlabStates;
    light_gray_concrete_stairs: LightGrayConcreteStairsStates;
    'minecraft:light_gray_concrete_stairs': LightGrayConcreteStairsStates;
    light_gray_stained_glass_pane: LightGrayStainedGlassPaneStates;
    'minecraft:light_gray_stained_glass_pane': LightGrayStainedGlassPaneStates;
    light_gray_wool_double_slab: LightGrayWoolDoubleSlabStates;
    'minecraft:light_gray_wool_double_slab': LightGrayWoolDoubleSlabStates;
    light_gray_wool_slab: LightGrayWoolSlabStates;
    'minecraft:light_gray_wool_slab': LightGrayWoolSlabStates;
    light_gray_wool_stairs: LightGrayWoolStairsStates;
    'minecraft:light_gray_wool_stairs': LightGrayWoolStairsStates;
    ...
    lime_concrete_double_slab: LimeConcreteDoubleSlabStates;
    'minecraft:lime_concrete_double_slab': LimeConcreteDoubleSlabStates;
    lime_concrete_slab: LimeConcreteSlabStates;
    'minecraft:lime_concrete_slab': LimeConcreteSlabStates;
    lime_concrete_stairs: LimeConcreteStairsStates;
    'minecraft:lime_concrete_stairs': LimeConcreteStairsStates;
    lime_glazed_terracotta: LimeGlazedTerracottaStates;
    'minecraft:lime_glazed_terracotta': LimeGlazedTerracottaStates;
    lime_stained_glass_pane: LimeStainedGlassPaneStates;
    'minecraft:lime_stained_glass_pane': LimeStainedGlassPaneStates;
    lime_wool_double_slab: LimeWoolDoubleSlabStates;
    'minecraft:lime_wool_double_slab': LimeWoolDoubleSlabStates;
    lime_wool_slab: LimeWoolSlabStates;
    'minecraft:lime_wool_slab': LimeWoolSlabStates;
    lime_wool_stairs: LimeWoolStairsStates;
    'minecraft:lime_wool_stairs': LimeWoolStairsStates;
    ...
    magenta_concrete_double_slab: MagentaConcreteDoubleSlabStates;
    'minecraft:magenta_concrete_double_slab': MagentaConcreteDoubleSlabStates;
    magenta_concrete_slab: MagentaConcreteSlabStates;
    'minecraft:magenta_concrete_slab': MagentaConcreteSlabStates;
    magenta_concrete_stairs: MagentaConcreteStairsStates;
    'minecraft:magenta_concrete_stairs': MagentaConcreteStairsStates;
    magenta_glazed_terracotta: MagentaGlazedTerracottaStates;
    'minecraft:magenta_glazed_terracotta': MagentaGlazedTerracottaStates;
    magenta_stained_glass_pane: MagentaStainedGlassPaneStates;
    'minecraft:magenta_stained_glass_pane': MagentaStainedGlassPaneStates;
    magenta_wool_double_slab: MagentaWoolDoubleSlabStates;
    'minecraft:magenta_wool_double_slab': MagentaWoolDoubleSlabStates;
    magenta_wool_slab: MagentaWoolSlabStates;
    'minecraft:magenta_wool_slab': MagentaWoolSlabStates;
    magenta_wool_stairs: MagentaWoolStairsStates;
    'minecraft:magenta_wool_stairs': MagentaWoolStairsStates;
    ...
    mangrove_fence: MangroveFenceStates;
    'minecraft:mangrove_fence': MangroveFenceStates;
    ...
    nether_brick_fence: NetherBrickFenceStates;
    'minecraft:nether_brick_fence': NetherBrickFenceStates;
    ...
    oak_fence: OakFenceStates;
    'minecraft:oak_fence': OakFenceStates;
    ...
    orange_concrete_double_slab: OrangeConcreteDoubleSlabStates;
    'minecraft:orange_concrete_double_slab': OrangeConcreteDoubleSlabStates;
    orange_concrete_slab: OrangeConcreteSlabStates;
    'minecraft:orange_concrete_slab': OrangeConcreteSlabStates;
    orange_concrete_stairs: OrangeConcreteStairsStates;
    'minecraft:orange_concrete_stairs': OrangeConcreteStairsStates;
    orange_glazed_terracotta: OrangeGlazedTerracottaStates;
    'minecraft:orange_glazed_terracotta': OrangeGlazedTerracottaStates;
    orange_poplar_leaves: OrangePoplarLeavesStates;
    'minecraft:orange_poplar_leaves': OrangePoplarLeavesStates;
    orange_stained_glass_pane: OrangeStainedGlassPaneStates;
    'minecraft:orange_stained_glass_pane': OrangeStainedGlassPaneStates;
    orange_wool_double_slab: OrangeWoolDoubleSlabStates;
    'minecraft:orange_wool_double_slab': OrangeWoolDoubleSlabStates;
    orange_wool_slab: OrangeWoolSlabStates;
    'minecraft:orange_wool_slab': OrangeWoolSlabStates;
    orange_wool_stairs: OrangeWoolStairsStates;
    'minecraft:orange_wool_stairs': OrangeWoolStairsStates;
    oxidized_copper_bars: OxidizedCopperBarsStates;
    'minecraft:oxidized_copper_bars': OxidizedCopperBarsStates;
    ...
    pale_oak_fence: PaleOakFenceStates;
    'minecraft:pale_oak_fence': PaleOakFenceStates;
    ...
    pink_concrete_double_slab: PinkConcreteDoubleSlabStates;
    'minecraft:pink_concrete_double_slab': PinkConcreteDoubleSlabStates;
    pink_concrete_slab: PinkConcreteSlabStates;
    'minecraft:pink_concrete_slab': PinkConcreteSlabStates;
    pink_concrete_stairs: PinkConcreteStairsStates;
    'minecraft:pink_concrete_stairs': PinkConcreteStairsStates;
    ...
    pink_stained_glass_pane: PinkStainedGlassPaneStates;
    'minecraft:pink_stained_glass_pane': PinkStainedGlassPaneStates;
    pink_wool_double_slab: PinkWoolDoubleSlabStates;
    'minecraft:pink_wool_double_slab': PinkWoolDoubleSlabStates;
    pink_wool_slab: PinkWoolSlabStates;
    'minecraft:pink_wool_slab': PinkWoolSlabStates;
    pink_wool_stairs: PinkWoolStairsStates;
    'minecraft:pink_wool_stairs': PinkWoolStairsStates;
    piston: PistonStates;
    ...
    poplar_button: PoplarButtonStates;
    'minecraft:poplar_button': PoplarButtonStates;
    poplar_door: PoplarDoorStates;
    'minecraft:poplar_door': PoplarDoorStates;
    poplar_double_slab: PoplarDoubleSlabStates;
    'minecraft:poplar_double_slab': PoplarDoubleSlabStates;
    poplar_fence: PoplarFenceStates;
    'minecraft:poplar_fence': PoplarFenceStates;
    poplar_fence_gate: PoplarFenceGateStates;
    'minecraft:poplar_fence_gate': PoplarFenceGateStates;
    poplar_hanging_sign: PoplarHangingSignStates;
    'minecraft:poplar_hanging_sign': PoplarHangingSignStates;
    poplar_log: PoplarLogStates;
    'minecraft:poplar_log': PoplarLogStates;
    poplar_pressure_plate: PoplarPressurePlateStates;
    'minecraft:poplar_pressure_plate': PoplarPressurePlateStates;
    poplar_sapling: PoplarSaplingStates;
    'minecraft:poplar_sapling': PoplarSaplingStates;
    poplar_shelf: PoplarShelfStates;
    'minecraft:poplar_shelf': PoplarShelfStates;
    poplar_slab: PoplarSlabStates;
    'minecraft:poplar_slab': PoplarSlabStates;
    poplar_stairs: PoplarStairsStates;
    'minecraft:poplar_stairs': PoplarStairsStates;
    poplar_standing_sign: PoplarStandingSignStates;
    'minecraft:poplar_standing_sign': PoplarStandingSignStates;
    poplar_trapdoor: PoplarTrapdoorStates;
    'minecraft:poplar_trapdoor': PoplarTrapdoorStates;
    poplar_wall_sign: PoplarWallSignStates;
    'minecraft:poplar_wall_sign': PoplarWallSignStates;
    poplar_wood: PoplarWoodStates;
    'minecraft:poplar_wood': PoplarWoodStates;
    portal: PortalStates;
    ...
    purple_concrete_double_slab: PurpleConcreteDoubleSlabStates;
    'minecraft:purple_concrete_double_slab': PurpleConcreteDoubleSlabStates;
    purple_concrete_slab: PurpleConcreteSlabStates;
    'minecraft:purple_concrete_slab': PurpleConcreteSlabStates;
    purple_concrete_stairs: PurpleConcreteStairsStates;
    'minecraft:purple_concrete_stairs': PurpleConcreteStairsStates;
    purple_glazed_terracotta: PurpleGlazedTerracottaStates;
    'minecraft:purple_glazed_terracotta': PurpleGlazedTerracottaStates;
    purple_stained_glass_pane: PurpleStainedGlassPaneStates;
    'minecraft:purple_stained_glass_pane': PurpleStainedGlassPaneStates;
    purple_wool_double_slab: PurpleWoolDoubleSlabStates;
    'minecraft:purple_wool_double_slab': PurpleWoolDoubleSlabStates;
    purple_wool_slab: PurpleWoolSlabStates;
    'minecraft:purple_wool_slab': PurpleWoolSlabStates;
    purple_wool_stairs: PurpleWoolStairsStates;
    'minecraft:purple_wool_stairs': PurpleWoolStairsStates;
    ...
    red_concrete_double_slab: RedConcreteDoubleSlabStates;
    'minecraft:red_concrete_double_slab': RedConcreteDoubleSlabStates;
    red_concrete_slab: RedConcreteSlabStates;
    'minecraft:red_concrete_slab': RedConcreteSlabStates;
    red_concrete_stairs: RedConcreteStairsStates;
    'minecraft:red_concrete_stairs': RedConcreteStairsStates;
    ...
    red_poplar_leaves: RedPoplarLeavesStates;
    'minecraft:red_poplar_leaves': RedPoplarLeavesStates;
    ...
    red_stained_glass_pane: RedStainedGlassPaneStates;
    'minecraft:red_stained_glass_pane': RedStainedGlassPaneStates;
    red_wool_double_slab: RedWoolDoubleSlabStates;
    'minecraft:red_wool_double_slab': RedWoolDoubleSlabStates;
    red_wool_slab: RedWoolSlabStates;
    'minecraft:red_wool_slab': RedWoolSlabStates;
    red_wool_stairs: RedWoolStairsStates;
    'minecraft:red_wool_stairs': RedWoolStairsStates;
    ...
    shelf_mushroom: ShelfMushroomStates;
    'minecraft:shelf_mushroom': ShelfMushroomStates;
    ...
    spruce_fence: SpruceFenceStates;
    'minecraft:spruce_fence': SpruceFenceStates;
    ...
    straw_bed: StrawBedStates;
    'minecraft:straw_bed': StrawBedStates;
    ...
    stripped_poplar_log: StrippedPoplarLogStates;
    'minecraft:stripped_poplar_log': StrippedPoplarLogStates;
    stripped_poplar_wood: StrippedPoplarWoodStates;
    'minecraft:stripped_poplar_wood': StrippedPoplarWoodStates;
    ...
    warped_fence: WarpedFenceStates;
    'minecraft:warped_fence': WarpedFenceStates;
    ...
    waxed_copper_bars: WaxedCopperBarsStates;
    'minecraft:waxed_copper_bars': WaxedCopperBarsStates;
    ...
    waxed_exposed_copper_bars: WaxedExposedCopperBarsStates;
    'minecraft:waxed_exposed_copper_bars': WaxedExposedCopperBarsStates;
    ...
    waxed_oxidized_copper_bars: WaxedOxidizedCopperBarsStates;
    'minecraft:waxed_oxidized_copper_bars': WaxedOxidizedCopperBarsStates;
    ...
    waxed_weathered_copper_bars: WaxedWeatheredCopperBarsStates;
    'minecraft:waxed_weathered_copper_bars': WaxedWeatheredCopperBarsStates;
    ...
    weathered_copper_bars: WeatheredCopperBarsStates;
    'minecraft:weathered_copper_bars': WeatheredCopperBarsStates;
    ...
    white_concrete_double_slab: WhiteConcreteDoubleSlabStates;
    'minecraft:white_concrete_double_slab': WhiteConcreteDoubleSlabStates;
    white_concrete_slab: WhiteConcreteSlabStates;
    'minecraft:white_concrete_slab': WhiteConcreteSlabStates;
    white_concrete_stairs: WhiteConcreteStairsStates;
    'minecraft:white_concrete_stairs': WhiteConcreteStairsStates;
    white_glazed_terracotta: WhiteGlazedTerracottaStates;
    'minecraft:white_glazed_terracotta': WhiteGlazedTerracottaStates;
    white_stained_glass_pane: WhiteStainedGlassPaneStates;
    'minecraft:white_stained_glass_pane': WhiteStainedGlassPaneStates;
    white_wool_double_slab: WhiteWoolDoubleSlabStates;
    'minecraft:white_wool_double_slab': WhiteWoolDoubleSlabStates;
    white_wool_slab: WhiteWoolSlabStates;
    'minecraft:white_wool_slab': WhiteWoolSlabStates;
    white_wool_stairs: WhiteWoolStairsStates;
    'minecraft:white_wool_stairs': WhiteWoolStairsStates;
    ...
    yellow_concrete_double_slab: YellowConcreteDoubleSlabStates;
    'minecraft:yellow_concrete_double_slab': YellowConcreteDoubleSlabStates;
    yellow_concrete_slab: YellowConcreteSlabStates;
    'minecraft:yellow_concrete_slab': YellowConcreteSlabStates;
    yellow_concrete_stairs: YellowConcreteStairsStates;
    'minecraft:yellow_concrete_stairs': YellowConcreteStairsStates;
    yellow_glazed_terracotta: YellowGlazedTerracottaStates;
    'minecraft:yellow_glazed_terracotta': YellowGlazedTerracottaStates;
    yellow_poplar_leaves: YellowPoplarLeavesStates;
    'minecraft:yellow_poplar_leaves': YellowPoplarLeavesStates;
    yellow_stained_glass_pane: YellowStainedGlassPaneStates;
    'minecraft:yellow_stained_glass_pane': YellowStainedGlassPaneStates;
    yellow_wool_double_slab: YellowWoolDoubleSlabStates;
    'minecraft:yellow_wool_double_slab': YellowWoolDoubleSlabStates;
    yellow_wool_slab: YellowWoolSlabStates;
    'minecraft:yellow_wool_slab': YellowWoolSlabStates;
    yellow_wool_stairs: YellowWoolStairsStates;
    'minecraft:yellow_wool_stairs': YellowWoolStairsStates;
